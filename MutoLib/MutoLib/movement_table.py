...
from MutoLib.movement_paths import *
from MutoLib.config import k_standby, standby_entries, standby_entries_count, move_paths

# from movement_paths import *
# from config import k_standby, standby_entries, standby_entries_count, move_paths
...
move_table = MovementTable([move_paths], 20, 20, (0, 10), 2)
# move_table = MovementTable(forward_paths, 20, 20, (0, 10), 2)
